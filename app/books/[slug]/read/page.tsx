      ...
      <article id="top" className="bk-page">
        ...
        {(book.body || []).map((c) => (
          <section key={c.ordinal} id={`chapter-${c.ordinal}`}
            ...
            <div className="bk-prose bk-chapter-body" style={{ marginTop: 34 }}
                 dangerouslySetInnerHTML={{ __html: prepareBody(c.html) }} />
        ...
        {book.conclusionHtml && (
          <section className="bk-chapter-break bk-prose" style={{ marginTop: 72 }}
                   dangerouslySetInnerHTML={{ __html: prepareBody(book.conclusionHtml) }} />
        )}
        {book.aboutAuthorHtml && (
          <section style={{ marginTop: 64 }}>
            ...
            <div className="bk-prose" dangerouslySetInnerHTML={{ __html: prepareBody(book.aboutAuthorHtml) }} />
          </section>
        )}
