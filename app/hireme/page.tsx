    ...
    <section className='bg-white dark:bg-gray-900'>
      <div className='py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
        ...
        <form onSubmit={handleSubmit} className='space-y-8'>
          ...
          <div>
            <label aria-label='subject' className='block mb-2 md:text-lg font-medium text-gray-900 dark:text-gray-300'>
              Subject
            </label>
            <input
              type='text'
          ...
          <div className='sm:col-span-2'>
            <label aria-label='message' className='block mb-2 md:text-lg font-medium text-gray-900 dark:text-gray-400'>
              Your message
            </label>
            <textarea
